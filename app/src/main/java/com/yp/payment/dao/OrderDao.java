...
public class OrderDao {
    ...
    public List<OrderDetail> queryOrderList() {
        String sql = "select * from order_info where shopId = '" + SPHelper.getShopId() + "' order by id desc limit 30";
...
//        return ObjectBox.getBoxStore().boxFor(OrderDetail.class).getAll();
    }
